...
add wave -noupdate -expand -group dcache /system_tb/DUT/CPU/CM/DCACHE/DCU/state
add wave -noupdate -expand -group dcache /system_tb/DUT/CPU/CM/DCACHE/DCU/statechange
add wave -noupdate -expand -group dcache /system_tb/DUT/CPU/CM/DCACHE/flctup
add wave -noupdate -expand -group dcache /system_tb/DUT/CPU/CM/DCACHE/flnum
add wave -noupdate -expand -group dcache /system_tb/DUT/CPU/CM/DCACHE/hitctup
add wave -noupdate -expand -group dcache /system_tb/DUT/CPU/CM/DCACHE/hitctdn
add wave -noupdate -expand -group dcache /system_tb/DUT/CPU/CM/DCACHE/hitctout
add wave -noupdate -expand -group dcache /system_tb/DUT/CPU/CM/DCACHE/hitnum
add wave -noupdate -expand -group dcache /system_tb/DUT/CPU/CM/DCACHE/dhit
add wave -noupdate -expand -group dcache /system_tb/DUT/CPU/CM/DCACHE/dhit0
add wave -noupdate -expand -group dcache /system_tb/DUT/CPU/CM/DCACHE/dhit1
add wave -noupdate -expand -group dcache /system_tb/DUT/CPU/CM/DCACHE/dirty
add wave -noupdate -expand -group dcache /system_tb/DUT/CPU/CM/DCACHE/dirties
add wave -noupdate -expand -group dcache /system_tb/DUT/CPU/CM/DCACHE/invalid
add wave -noupdate -expand -group dcache /system_tb/DUT/CPU/CM/DCACHE/flushing
add wave -noupdate -expand -group dcache /system_tb/DUT/CPU/CM/DCACHE/cublof
add wave -noupdate -expand -group dcache /system_tb/DUT/CPU/CM/DCACHE/ind
add wave -noupdate -expand -group dcache /system_tb/DUT/CPU/CM/DCACHE/waysel
add wave -noupdate -expand -group dcache /system_tb/DUT/CPU/CM/DCACHE/blksel
add wave -noupdate -expand -group dcache /system_tb/DUT/CPU/CM/DCACHE/srcsel
add wave -noupdate -expand -group dcache /system_tb/DUT/CPU/CM/DCACHE/cacheWEN
add wave -noupdate -expand -group dcache /system_tb/DUT/CPU/CM/DCACHE/cacheout
add wave -noupdate -expand -group dcache /system_tb/DUT/CPU/CM/DCACHE/memaddr
add wave -noupdate -expand -group dcache /system_tb/DUT/CPU/CM/DCACHE/cacheaddr
add wave -noupdate -expand -group dcache /system_tb/DUT/CPU/CM/DCACHE/dpaddr
add wave -noupdate -expand -group dcache /system_tb/DUT/CPU/CM/DCACHE/alldirties
add wave -noupdate -expand -group dcache -expand -subitemconfig {{/system_tb/DUT/CPU/CM/DCACHE/dcbuf[1]} -expand {/system_tb/DUT/CPU/CM/DCACHE/dcbuf[1][0]} -expand {/system_tb/DUT/CPU/CM/DCACHE/dcbuf[1][0].dcblock} -expand {/system_tb/DUT/CPU/CM/DCACHE/dcbuf[0][0]} -expand} /system_tb/DUT/CPU/CM/DCACHE/dcbuf
add wave -noupdate -expand -group dcache /system_tb/DUT/CPU/CM/DCACHE/lru
add wave -noupdate -expand -group dcache /system_tb/DUT/CPU/CM/DCACHE/addr
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {17276401 ps} 0}
...
update
WaveRestoreZoom {16443 ns} {18741 ns}
