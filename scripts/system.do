...
add wave -noupdate -group ifif /system_tb/DUT/CPU/DP/ifif/ihit
...
add wave -noupdate -group id2if /system_tb/DUT/CPU/DP/id2if/ihit
...
add wave -noupdate -group ex1if /system_tb/DUT/CPU/DP/ex1if/ihit
...
add wave -noupdate -group ex2if /system_tb/DUT/CPU/DP/ex2if/ihit
...
add wave -noupdate -group mm2if /system_tb/DUT/CPU/DP/mm2if/ihit
add wave -noupdate -group mm2if /system_tb/DUT/CPU/DP/mm2if/dhit
...
WaveRestoreCursors {{Cursor 1} {483486 ps} 0}
...
update
WaveRestoreZoom {152 ns} {1124 ns}
