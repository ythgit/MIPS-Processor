...
add wave -noupdate -expand -group dcaches /system_tb/DUT/CPU/CM/DCACHE/dcbuf
...
WaveRestoreCursors {{Cursor 1} {1298160462 ps} 0}
...
update
WaveRestoreZoom {1294641100 ps} {1316703100 ps}
