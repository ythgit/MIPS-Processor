...
add wave -noupdate /system_tb/DUT/CPU/CC/CC/serveaddr
add wave -noupdate /system_tb/DUT/CPU/CC/CC/daddr0
add wave -noupdate /system_tb/DUT/CPU/CC/CC/daddr1
...
add wave -noupdate -group CM0 /system_tb/DUT/CPU/DP0/dpif/dmemaddr
add wave -noupdate -group CM0 -expand /system_tb/DUT/CPU/CM0/DCACHE/addr
...
add wave -noupdate -group CM0 /system_tb/DUT/CPU/CM0/DCACHE/success
add wave -noupdate -group CM0 /system_tb/DUT/CPU/CM0/DCACHE/llvalid
add wave -noupdate -group CM0 /system_tb/DUT/CPU/CM0/DCACHE/llreg
...
add wave -noupdate -group CM0 /system_tb/DUT/CPU/CM0/DCACHE/dhit
add wave -noupdate -group CM0 /system_tb/DUT/CPU/CM0/DCACHE/ccdhit
...
add wave -noupdate -group DP1 /system_tb/DUT/CPU/dcif0/dmemload
...
add wave -noupdate -expand -group CM1 -expand -subitemconfig {{/system_tb/DUT/CPU/CM1/DCACHE/dcbuf[4]} -expand {/system_tb/DUT/CPU/CM1/DCACHE/dcbuf[0]} -expand {/system_tb/DUT/CPU/CM1/DCACHE/dcbuf[0][0]} -expand} /system_tb/DUT/CPU/CM1/DCACHE/dcbuf
...
add wave -noupdate -expand -group CM1 /system_tb/DUT/CPU/CM1/cif/dstore
...
WaveRestoreCursors {{Cursor 1} {22778989 ps} 0}
...
update
WaveRestoreZoom {21864 ns} {24032 ns}
