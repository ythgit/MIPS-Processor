...
add wave -noupdate -expand -group DP0 -expand -subitemconfig {{/system_tb/DUT/CPU/CM0/ICACHE/cache[0]} -expand} /system_tb/DUT/CPU/CM0/ICACHE/cache
...
add wave -noupdate -expand -group DP1 -expand /system_tb/DUT/CPU/CM1/ICACHE/cache
...
add wave -noupdate -group CM1 /system_tb/DUT/CPU/CM1/DCACHE/dcbuf
...
WaveRestoreCursors {{Cursor 1} {426850 ps} 0}
